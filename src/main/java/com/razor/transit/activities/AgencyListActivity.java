                                                            ...
                                                            OnViewModelListAdapterListener
{
    ...
    public void onListItemSelected(final View view)
    {
        ...
        // showRouteList.putExtra(RouteListActivity.ROUTE_LIST_AGENCY_MODEL_INTENT_VALUE,
        // viewModel);

        Intent showStopsOnMap = new Intent(this, TransitMapActivity.class);
        showStopsOnMap.putExtra(TransitMapActivity.TRANSIT_MAP_AGENCY_MODEL_INTENT_VALUE,
                viewModel);
        this.startActivity(showStopsOnMap);
