        ...
        implements IBetterLocationListener
{
    ...
    public UUID getUniqueIdentifier(){
        if (this.privateUniqueIdentifier == null) {
            ApplicationPreferenceWrapper applicationPreferenceWrapper
                    = new ApplicationPreferenceWrapper(this);

            String uuIdValue = applicationPreferenceWrapper
                    .getGeneralPreferences()
                    .getPreference("UUID", java.util.UUID.randomUUID().toString());

            this.privateUniqueIdentifier = java.util.UUID.fromString(uuIdValue);
        }
